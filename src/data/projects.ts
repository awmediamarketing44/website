...
const webProjects: ProjectData[] = [
  {
    ...
    tags: ["Bespoke App", "Coaching Platform", "Phone First", "Data Migration"],
    heroImage: "/images/projects/skulpt/hero.jpg",
    thumbnailImage: "/images/projects/skulpt/thumb.jpg",
    hasImages: true,
    year: "2026",
    client: {
      name: "Skulpt Triathlon",
      industry: "Triathlon Coaching",
      location: "UK",
      website: "https://skulpttri.co.uk/",
    },
    brief:
      "A triathlon coach writing swim, bike, run, brick and strength sessions in a spreadsheet, and athletes trying to train off it on their phones at six in the morning. We built the app instead: the coach writes the block, the athlete opens their phone and sees today's session, the numbers to hit and what to eat.",
    challenge: [
      "The plan lived in a spreadsheet. Readable on a laptop, hopeless at the poolside, and impossible to log anything back into.",
      "Endurance training is structured: intervals, zones, rest, RPE. A spreadsheet flattens all of that into text, so athletes guess and the coach has no idea what was actually done.",
      "Nutrition sat in a different place again, which is the half most triathletes get wrong.",
      "Years of existing plans and history had to come across. Starting everybody from a blank app was never an option.",
    ],
    approach: [
      "A phone-first app that installs to the home screen, so it opens like any other app without anybody going near an app store.",
      "Sessions are structured properly: steps, zones, target paces and RPE, with the last time they did that session sat underneath it for comparison.",
      "Strength gets its own library, every movement linked to a demo and cues, so a session is followed rather than interpreted.",
      "Nutrition and hydration logged in the same app as the training, because the two are the same conversation.",
      "The coach side builds weeks and blocks, reviews check-ins and sees who is drifting. The athlete side only ever shows today's job.",
      "307 existing sessions were migrated and read back off the server to prove nothing had been lost or mangled on the way in.",
    ],
    features: [
      "Swim, bike, run, brick and strength sessions",
      "Structured steps with zones, paces and RPE",
      "Exercise library with demos and cues",
      "Nutrition, hydration and food logging",
      "Weekly check-ins and coach review",
      "Week and block builder for the coach",
      "Installs to the home screen, works offline-first",
      "Full migration of existing plans and history",
    ],
    results: {
      stats: [
    ...
    gallery: [
      "/images/projects/skulpt/desktop.jpg",
      "/images/projects/skulpt/mobile.jpg",
    ],
    showcase: [
      "/images/projects/skulpt/showcase/app-athlete-day.webp",
      "/images/projects/skulpt/showcase/app-coach.webp",
      "/images/projects/skulpt/showcase/app-nutrition.webp",
      "/images/projects/skulpt/showcase/app-extras.webp",
      "/images/projects/skulpt/showcase/app-onboarding.webp",
      "/images/projects/skulpt/showcase/app-owner.webp",
    ],
  ...
  },
  {
    ...
    title: "1 of 1 Hub",
    category: "Systems & Platforms",
    tags: ["Bespoke App", "Coaching Platform", "Wearables", "Phone First"],
    heroImage: "/images/projects/1of1-hub/hero.jpg",
    thumbnailImage: "/images/projects/1of1-hub/thumb.jpg",
    hasImages: true,
    year: "2026",
    client: {
      name: "1 of 1",
      industry: "Physique Coaching",
      location: "UK",
      website: "https://1of1hub.com/",
    },
    brief:
      "A physique coach running everything through a Google Sheet. We put the app on top of it: his plan lands on the client's phone, and their weight, sleep, steps, biofeedback, training and weekly check-in photos go back into his sheet on their own.",
    challenge: [
      "The sheet worked for the coach and nobody else. Clients were sent tabs they could not read on a phone and asked to type numbers back into cells.",
      "Everything useful arrived late and in pieces: a weight in WhatsApp, a photo in an email, a training note that never came at all.",
      "He did not want to abandon the sheet. It is how he thinks, and his whole process lives in it.",
      "Progress photos are sensitive. They needed handling properly rather than sitting in a shared folder.",
    ],
    approach: [
      "The app reads and writes his existing sheet, so the coach carries on working the way he always has while clients get something built for a phone.",
      "Clients log weight, sleep, steps, biofeedback and their training as they go, and it lands back in the sheet without anybody copying anything.",
      "Weekly check-ins with private progress photos, stored properly, with consent handled and deletion available in the app.",
      "Wearable data comes in automatically where the client has it, so the numbers are not another daily chore.",
      "Messaging and notifications built in, so the coaching conversation is attached to the data instead of scattered across three apps.",
      "Installs to the home screen and is hosted in the UK, with the client owning the code and the data outright.",
    ],
    features: [
      "Two-way sync with the coach's own Google Sheet",
      "Daily logging: weight, sleep, steps, biofeedback",
      "Training logged set by set",
      "Weekly check-ins with private progress photos",
      "Wearable data pulled in automatically",
      "In-app messaging with unread badges",
      "Two-factor sign in, consent and in-app deletion",
      "Installs to the home screen, UK hosted",
    ],
    gallery: [
      "/images/projects/1of1-hub/desktop.jpg",
      "/images/projects/1of1-hub/mobile.jpg",
    ],
  ...
  },
  {
    ...
    year: "2026",
    client: {
      name: "The Personal Trainer Business Blueprint",
      industry: "Coach Education & Certification",
      location: "UK",
      website: "https://theptbusinessblueprint.com/",
    },
    brief:
      "A CIMSPA endorsed business course for personal trainers, and the whole business that has to run underneath it. Sales site, student platform, a white-labelled portal gyms buy seats on, the back office, the payments, and the 160 page workbook that lands on the doormat. One build, not five plugins bolted together.",
    challenge: [
      "Selling a course is the easy half. Enrolling students, marking their work, invoicing gyms, booking the calls and getting a printed workbook to the right address is where these things usually fall apart.",
      "Off the shelf course platforms take a cut, look like everyone else's, and stop dead at the point a gym wants to buy twenty seats and brand the thing as their own.",
      "Everything had to be editable by the owner. On the old setup, changing one line of wording on the sales page meant a developer and a risky deploy.",
      "Assessments had to be marked by a real coach with real feedback, not a multiple choice quiz that hands out a certificate to anybody who clicks enough times.",
    ],
    approach: [
      "We built the lot as one platform: the sales site, the student course area, a gym business portal, the admin back office and Stripe checkout, all sharing the same data.",
      "Gyms buy a block of seats and get their own white-labelled portal. They upload their logo, pick two colours with an eyedropper, add their trainers and watch who is stalling. A seat is only used once a trainer actually signs in, so nothing is burned on somebody who never turns up.",
      "Seven portfolio assessments are marked by a coach, with written feedback on every question and a pass or resubmit. No percentages, and SLA badges so nothing sits in a queue.",
      "The booking side replaced Calendly entirely: paid one to one calls and a free discovery call for gyms, one shared diary, two way Google Calendar, a Meet link written into the invite and reminders the day before.",
      "The owner edits everything himself. Course content, sales page wording, prices, users, gym rosters, discount codes created for real in Stripe, orders and the fulfilment board for the printed workbooks.",
    ],
    features: [
      "Course platform: 7 modules, 41 lessons, 10 tools",
      "7 coach-marked portfolio assessments",
      "White-labelled gym portal with seat management",
      "Own booking engine, two-way Google Calendar",
      "Stripe checkout, orders and discount codes",
      "160-page printed workbook, 216 fillable fields",
      "Certificate generator and fulfilment board",
      "42 custom diagrams drawn for the course",
      "Two free lead tools and a 20-page sample for gyms",
      "CIMSPA endorsed, worth 10 CPD points",
    ],
    gallery: [
      "/images/projects/pt-business-blueprint/desktop.jpg",
  ...
  },
  {
    ...
    client: {
      name: "PT Desk",
      industry: "Software for Personal Trainers",
      location: "Leeds & Sheffield",
      website: "https://ptdesk.co.uk/",
    },
    brief:
      "Scheduling, payments and paperwork software for personal trainers, designed and built by us from the database up. It deliberately does not touch the coaching. Programmes, check-ins and nutrition stay in whatever app the trainer already uses, and PT Desk takes the admin that eats their evenings.",
    challenge: [
      "Coaching apps are built for delivering training, so the business side gets bolted on badly: no-shows nobody chases, packages nobody counts, PAR-Qs in an inbox.",
      "Every alternative wants the trainer to move platform. Nobody wants to migrate their clients twice, so the answer had to sit alongside what they already run.",
      "The money had to collect itself. A trainer asking for forty five quid after a missed session is a conversation nobody wants to have.",
      "It had to look like the trainer's business, not ours, right down to the confirmation emails.",
    ],
    approach: [
      "One booking link. Only the hours the trainer has actually opened are bookable, and anything already in their own calendar blocks itself out, both ways with Google and Outlook.",
      "Payment is handled before they turn up: deposits, prepayment, blocks of sessions or a monthly plan, with the card held so a late cancellation charges itself against the trainer's own policy.",
      "PAR-Q, waiver and contract go out on booking and come back signed, and anything needing GP clearance is flagged before that person trains.",
      "The bit a diary will never do: it watches the business underneath. Nine weeks above seventy percent capacity and it says put your rates up, with the maths done. Two sessions left on a package and it says who to talk to.",
      "White-labelled throughout. Their logo, their colours, their booking link, and confirmations that look like they came from them.",
    ],
    features: [
      "Booking, rescheduling and cancellations",
      "Deposits, packages and monthly plans",
      "Automatic no-show and late cancellation policies",
      "PAR-Q, waivers and e-signatures",
      "Two-way Google and Outlook calendar sync",
      "Capacity and renewal prompts with the maths done",
      "Fully white-labelled, including emails",
      "Client-side demo so trainers see what clients see",
    ],
    gallery: [
      "/images/projects/pt-desk/desktop.jpg",
  ...
  },
  {
    ...
    client: {
      name: "Adept Heating",
      industry: "Heating & Gas Engineer",
      location: "South Anston, South Yorkshire",
      website: "https://adeptheating.co.uk/",
    },
    brief:
      "A Gas Safe heating engineer with a stack of five star reviews and nowhere to send anybody. No website at all, while three firms with less proof sat above him in the search results. We built 34 bespoke pages, moved the domain, email and hosting across, and put the real reviews on the page.",
    challenge: [
      "No website. Every enquiry came through word of mouth, and anybody who searched found the competition instead.",
      "The business rebranded and moved area mid-project, which re-anchored every location page and all the local SEO work with it.",
      "Trades sites are usually a page builder, five plugins and a contact form nobody tests. That is what makes them slow and what makes them break.",
      "Somebody standing next to a broken boiler is not filling in a long form. They want to ring, or send a photo.",
    ],
    approach: [
      "34 bespoke pages: 17 for the services, 10 for the areas he covers, plus the core of the site. Written for what people actually search for at the point their heating packs in.",
      "Everything bespoke lives in one custom plugin. No page builder, no SEO plugin, and our own schema, sitemap, robots and llms.txt so AI search can read it as cleanly as Google does.",
      "Real Google reviews are pulled in twice a day by a cron job and rendered in our own card design. No third party script on page load, and the section can never sit there blank.",
      "One tap to WhatsApp so somebody can send a photo of the boiler and the error code, and a click to call that adapts to the device.",
      "Domain, DNS, SSL and Microsoft 365 email all moved across with no downtime, every record checked by hand before the switch.",
    ],
    features: [
      "34 bespoke pages, 17 services and 10 locations",
      "Custom plugin, no page builder, no SEO plugin",
      "Live Google reviews, cached twice daily",
      "FAQ schema across 17 pages",
      "One-tap WhatsApp with photo, adaptive click-to-call",
      "Domain, DNS, SSL and email migration, zero downtime",
      "Own sitemap, robots and llms.txt for AI search",
    ],
    gallery: [
      "/images/projects/adept-heating/desktop.jpg",
  ...
  },
  {
    ...
    year: "2026",
    client: {
      name: "Alex Hall Coaching",
      industry: "Coaching for Women 40+",
      location: "UK",
      website: "https://fulltray.alexhallcoaching.co.uk/",
    },
    brief:
      "A recipe book for women in perimenopause and menopause, built as a product rather than a PDF. We did the brand, designed and typeset all 157 pages, then built the sales page it is sold from, with a price schedule that moves on its own.",
    challenge: [
      "Most coach ebooks are a Word document exported to PDF. This had to look like something off a shelf, because that is what it is charging for.",
      "The content had a job to do, not just recipes. Fibre matters enormously for this audience, so the numbers had to be visible and honest on every page.",
      "It needed a print edition as well as a digital one, which means real page geometry, a spine width and QR codes that actually resolve.",
      "The sales page had to run a launch on its own, with prices that change on schedule, while staying editable by somebody who does not touch code.",
    ],
    approach: [
      "Brand first: logo lockups in four colourways, a palette with measured contrast behind the coral rule, and a type system that holds up at recipe size and at cover size.",
      "47 recipes across 5 chapters, designed page by page. 157 pages digital, 160 in print, with the fibre per serving on every recipe and 45 QR codes linking the print edition to the videos.",
      "A 28 day plan that builds fibre deliberately from 34g to 49g a day, so the book teaches the habit rather than just feeding somebody for a month.",
      "The sales page is a bespoke plugin with a locked content-only editor, so the wording and the price schedule can be changed without anything else being at risk.",
    ],
    features: [
      "Full brand identity and guidelines",
      "47 recipes across 5 chapters",
      "157-page digital edition, 160-page print edition",
      "45 videos, 45 QR codes in the print edition",
      "28-day plan, fibre climbing 34g to 49g",
      "Bespoke sales page with scheduled pricing",
      "Content-only editor, locked layout",
    ],
    gallery: [
      "/images/projects/full-tray/desktop.jpg",
      "/images/projects/full-tray/mobile.jpg",
      "/images/projects/full-tray/desktop-full.jpg",
    ],
    pages: [
      "/images/projects/full-tray/pages/glass-hero.webp",
      "/images/projects/full-tray/pages/glass-howtheywork.webp",
      "/images/projects/full-tray/pages/glass-mealplan.webp",
      "/images/projects/full-tray/pages/glass-reviews.webp",
      "/images/projects/full-tray/pages/glass-buy.webp",
    ],
    pagesTitle: ["The page it", "sells from."],
    pagesSubtitle:
      "Written and built to do one job: explain what the book is, show enough of it, and take the payment.",
    documents: [
      "/images/projects/full-tray/documents/book-cover.webp",
      "/images/projects/full-tray/documents/book-chapter.webp",
      "/images/projects/full-tray/documents/book-weekone.webp",
      "/images/projects/full-tray/documents/book-cheatsheet.webp",
      "/images/projects/full-tray/documents/book-fibre.webp",
      "/images/projects/full-tray/documents/book-author.webp",
    ],
    documentsTitle: ["157 pages,", "designed properly."],
    documentsSubtitle:
      "Every page set by hand, with the fibre numbers on the recipe rather than buried in an appendix.",
    showcase: [
      "/images/projects/full-tray/showcase/book-spread-recipe.webp",
      "/images/projects/full-tray/showcase/book-spread-plan.webp",
      "/images/projects/full-tray/showcase/palette-ratio-whitetext.webp",
      "/images/projects/full-tray/showcase/type-whitetext.webp",
    ],
    showcaseTitle: ["The brand", "behind it."],
    showcaseSubtitle:
      "Spreads, the palette with its contrast ratios, and the type system that had to work at recipe size and cover size.",
    relatedProjects: ["dan-james", "trident-coaching", "calibre-coaching"],
  },
  {
