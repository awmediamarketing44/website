...
const reasons = [
  {
    title: "We deliver on time. Always.",
    description:
      "No chasing. No delays. We set a timeline and stick to it because we know your launch date matters.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Your website needs ongoing care. We're here for updates, fixes, and support whenever you need us.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "We're not corporate. We're direct.",
    description:
      "No jargon. No fluff. Just honest conversations about what your business actually needs to grow online.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "A decade in. Still hungry.",
    description:
      "AW Media started in 2016 as one person. Now a team of 5. 400+ websites shipped. Multiple awards. We've seen every trend come and go, and we still build what actually converts.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <TiltCard>
                <div className="group relative overflow-hidden rounded-2xl border border-card-border bg-card p-8 transition-all duration-500 hover:border-pink/30 min-h-[220px]">
                  ...
                  <div className="relative z-10">
                    <motion.div
                      className="mb-4 w-12 h-12 rounded-xl bg-pink/10 flex items-center justify-center text-pink"
                      whileHover={{ rotate: 360, scale: 1.1 }}
                      transition={{ duration: 0.5 }}
                    >
                      {reason.icon}
                    </motion.div>
                    <h3 className="text-lg font-bold mb-2 group-hover:text-pink transition-colors duration-300">
                      {reason.title}
                    </h3>
