...
const reasons = [
  ...
  },
  {
    ...
    description:
      "AW Media started in 2016 as one person. Now a team of 5. 450+ websites shipped. Multiple awards. We've seen every trend come and go, and we still build what actually converts.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
