      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight max-w-2xl">
            Stop paying multiple agencies for things that should{" "}
            <span className="text-pink">work together.</span>
          </h2>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group rounded-2xl border border-card-border bg-card p-8 transition-colors duration-300 hover:border-pink/30"
            >
              <div className="mb-4 text-pink">{service.icon}</div>
