            ...
            {workCards.map((card, i) => (
              ...
              >
                <TiltCard className="h-full">
                  <div className="aw-sheen group relative overflow-hidden rounded-2xl border border-card-border bg-card p-4 sm:p-6 h-36 sm:h-44 flex flex-col justify-between transition-colors duration-300 hover:border-pink/30">
