...
function VariantCard({
  ...
  return (
    ...
    >
      ...
      >
        Start a {laneLabel} {tier.name.toLowerCase()}
      </Link>
    </motion.div>
  );
}
    ...
    <>
      ...
      <main>
        <PageHeader
          ...
          title="Two ways to build your website."
          titleAccent="Both bespoke. Neither cheap."
          description="We don't do templates. We use AI to build faster, smarter websites — or we go full bespoke when the project demands it. You choose how we work. We deliver either way."
        />
        ...
        <section className="py-12 border-t border-card-border">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="mt-12 text-xs text-muted text-center"
            >
              All prices exclude VAT. Hosting and domain charged separately or
              via the AW Media monthly hosting plan.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-24 border-t border-card-border relative overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
            ...
            >
              Drop us a line. We&apos;ll tell you straight.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
